...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		...
		// display the student and associated courses
		...
		Course tempCourse2 = new Course("Atari 2600 - Game Programming for Beginners");	
	...
	private void findCourseAndStudents(AppDAO appDAO) {
		...
		// display the course and associated students
